      ...
      <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <button
            type="submit"
            disabled={cargando}
            className={`w-full sm:flex-1 p-3 rounded-md text-white font-semibold transition-colors text-sm sm:text-base ${
              cargando
          ...
          <button
            ...
            className="w-full sm:flex-1 p-3 rounded-md bg-gray-400 text-white font-semibold hover:bg-gray-500 transition-colors text-sm sm:text-base"
          >
            Limpiar
          </button>
        </div>
